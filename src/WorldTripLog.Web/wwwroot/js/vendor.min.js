...
(function(){"use strict";var n={},i={stops:[],currentStop:0,selector:"#map",icon:{url:"data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAYAAAAGCAIAAABvrngfAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsMAAA7DAcdvqGQAAAAadEVYdFNvZnR3YXJlAFBhaW50Lk5FVCB2My41LjExR/NCNwAAAA1JREFUGFdjoDNgYAAAAHIAAejt7scAAAAASUVORK5CYII=",width:3,height:3},initialZoom:4,pastStroke:{color:"#190300",opacity:.5,weight:2},futureStroke:{color:"#D30000",opacity:.6,weight:2},mapOptions:{draggable:!0,scrollwheel:!1,disableDoubleClickZoom:!0,zoomControl:!0},overlay:{className:"travelmap-overlay"}};n.createMap=function(n){var e,r=f(n,i),s,h;if(!r.stops||0==r.stops.length)throw"You must supply stops when creating a map.";var c=r.stops.slice(0,r.currentStop+1),l=r.stops.slice(r.currentStop,r.stops.length),o=r.stops[r.currentStop];for(u(),"function"==typeof GMaps&&window.GMaps||console.log("GMaps (and Google Maps API) is required. Please register the following JavaScript library https://hpneo.github.io/gmaps/documentation.html"),e=new GMaps({div:r.selector,lat:o.lat,lng:o.long,zoom:r.initialZoom}),e.map.setOptions(r.mapOptions),e.drawPolyline({path:t(c),strokeColor:r.pastStroke.color,strokeOpacity:r.pastStroke.opacity,strokeWeight:r.pastStroke.weight}),e.drawPolyline({path:t(l),strokeColor:r.futureStroke.color,strokeOpacity:r.futureStroke.opacity,strokeWeight:r.futureStroke.weight}),s=0;s<r.stops.length;++s)h=r.stops[s],s!=r.currentStop&&e.addMarker({lat:h.lat,lng:h.long,icon:r.icon.url,infoWindow:{content:h.info},anchorPoint:{x:r.icon.width/2,y:r.icon.height/2}});return e.drawOverlay({lat:o.lat,lng:o.long,content:'<div class="'+r.overlay.className+'">Current Location<br/>'+o.info+'<div class="'+r.overlay.className+"-arrow "+r.overlay.className+'-arrow-above"><\/div><\/div>',verticalAlign:"top",horizontalAlign:"center",layer:"overlayImage"}),{map:e,settings:r,currentLocation:o}};var r=function(n){return[n.lat,n.long]},t=function(n){for(var i=[],t=0;t<n.length;++t)i.push(r(n[t]));return i},u=function(){var n=document.createElement("style");n.innerHTML=".stopName { background: none repeat scroll 0 0 #222; width: 4px; height: 4px; }.gm-style-iw{ overflow: hidden !important; } .travelmap-overlay{  display:block;  text-align:center;  color:#fff;  font-size:12px;  line-height:14px;  opacity:0.8;  background:#4477aa;  border:solid 3px #336699;  border-radius:4px;  box-shadow:2px 2px 10px #333;  text-shadow:1px 1px 1px #666;  padding:0 4px;  margin-top: -24px;  white-space: nowrap;}.travelmap-overlay-arrow{  left:50%;  margin-left:-16px;  width:0;  height:0;  position:absolute;}.travelmap-overlay-arrow.travelmap-overlay-arrow-above{  bottom:-15px;  border-left:16px solid transparent;  border-right:16px solid transparent;  border-top:16px solid #336699;}.travelmap-overlay-arrow.travelmap-overlay-arrow-below{  top:-15px;  border-left:16px solid transparent;  border-right:16px solid transparent;  border-bottom:16px solid #336699;}";document.head.appendChild(n)},f=function(n,t){var r=t;for(var i in n)n.hasOwnProperty(i)&&void 0!==n[i]&&(r[i]=n[i]);return r};"undefined"!=typeof exports?("undefined"!=typeof module&&module.exports&&(exports=module.exports=n),exports.travelMap=n):this.travelMap=n;"function"==typeof define&&define.amd&&define("travelMap",[],function(){return n})}).call(this);